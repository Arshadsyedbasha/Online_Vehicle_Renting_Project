...
function CarExplore() {
  ...
  const handleRentNow = (bicycle) => {
    navigate('/co', { state: { veaddress: bicycle.address } });
  };
                ...
                >
                  ...
                  <CardContent sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between', flexGrow: 1 }}>
                    <Box>
                      ...
                      <Typography variant="body2" color="text.secondary"><b>License Plate:</b>
                        {bicycle.plate || 'No Plate Number Provided'} 
                      </Typography>
                      <Typography variant="body2" color="text.secondary"><b>Email:</b>
                        {bicycle.email || 'No Email Provided'} 
                      </Typography>
                      <Typography variant="body2" color="text.secondary"><b>Address:</b>
                        {bicycle.address || 'No Address Provided'} 
                      </Typography>
                      <Typography variant="body2" color="text.secondary"><b>Mileage:</b>
                        {bicycle.mileage || 'No Mileage Provided'} 
                      </Typography>
                      <Typography variant="body2" color="text.secondary"><b>Seats:</b>
                        {bicycle.seats || 'No Seat Information Provided'} 
                      </Typography>
                      <Typography variant="subtitle1" component="div" sx={{ mt: 1 }}>
                        Price per Day: {bicycle.price || 'N/A'} 
                      </Typography>
                      {/* Display mileage and seats */}
